...
//第一页开始
        ...
        var sky:egret.Bitmap = this.createBitmapByName("02_jpg");
        page1.addChild(sky);
        sky.width = stageW;
        sky.height = stageH;        
        ...
        var avatar:egret.Bitmap = this.createBitmapByName("avatar_png");
...
//第二页开始
        ...
        var sky2:egret.Bitmap = this.createBitmapByName("02_jpg");
        page2.addChild(sky2);
        sky2.width = stageW;
        sky2.height = stageH;
        ...
        var avatar2:egret.Bitmap = this.createBitmapByName("avatar_png");
        ...
        var changeavatar:Function = function () {
...
//第三页开始
        ...
        var sky3:egret.Bitmap = this.createBitmapByName("02_jpg");
        page3.addChild(sky3);
        sky3.width = stageW;
        sky3.height = stageH;
        ...
        var COD:egret.Bitmap = this.createBitmapByName("COD_jpg");
        page3.addChild(COD);
        COD.scaleX = 0.15;
        COD.scaleY = 0.15;
        ...
        var CORPSE:egret.Bitmap = this.createBitmapByName("CORPSE_jpg");
        ...
        var HOI:egret.Bitmap = this.createBitmapByName("HOI_jpg");
        page3.addChild(HOI);
        ...
        var SNH:egret.Bitmap = this.createBitmapByName("SNH_jpg");
        page3.addChild(SNH);
        ...
        var CODBIG:egret.Bitmap = this.createBitmapByName("COD_jpg");
        ...
        function onTouchCODbig(event:egret.Event){
        ...
        function onTouchCODsmall(event:egret.Event){
        ...
        var HOIBIG:egret.Bitmap = this.createBitmapByName("HOI_jpg");
        ...
        function onTouchHOIbig(event:egret.Event){
            page3.addChild(pictureMask);
        ...
        function onTouchHOIsmall(event:egret.Event){
            page3.removeChild(pictureMask);
        ...
        var SNHBIG:egret.Bitmap = this.createBitmapByName("SNH_jpg");
        ...
        function onTouchSNHbig(event:egret.Event){
            page3.addChild(pictureMask);
        ...
        function onTouchSNHsmall(event:egret.Event){
            page3.removeChild(pictureMask);
        ...
        var CORPSEBIG:egret.Bitmap = this.createBitmapByName("CORPSE_jpg");
        ...
        function onTouchCORPSEbig(event:egret.Event){
            page3.addChild(pictureMask);
        ...
        function onTouchCORPSEsmall(event:egret.Event){
            page3.removeChild(pictureMask);
...
//第四页开始
    ...
    var page4 = new egret.DisplayObjectContainer();
        ...
        var sky4:egret.Bitmap = this.createBitmapByName("02_jpg");
        page4.addChild(sky4);
        sky4.width = stageW;
        sky4.height = stageH;
        ...
        var snowhalation:egret.Bitmap = this.createBitmapByName("snowhalation_jpg");
        ...
        var flowerdance:egret.Bitmap = this.createBitmapByName("flowerdance_png");
        ...
        var streetdreams:egret.Bitmap = this.createBitmapByName("streetdreams_jpg");
        ...
        var twilight:egret.Bitmap = this.createBitmapByName("twilight_jpg");
...
//音频播放
        ...
        flowerloader.dataFormat = egret.URLLoaderDataFormat.SOUND;
        flowerloader.load(new egret.URLRequest("resource/flowerdance.mp3"));
        flowerloader.addEventListener(egret.Event.COMPLETE, function flowerloadOver(event:egret.Event) {
            flowersign = true;
        }, this);
        ...
        twiloader.dataFormat = egret.URLLoaderDataFormat.SOUND;
        twiloader.load(new egret.URLRequest("resource/twilight.mp3"));
        twiloader.addEventListener(egret.Event.COMPLETE, function twiloadOver(event:egret.Event) {
            twisign = true;
        }, this);
        ...
        snowloader.dataFormat = egret.URLLoaderDataFormat.SOUND;
        snowloader.load(new egret.URLRequest("resource/snowhalation.mp3"));
        snowloader.addEventListener(egret.Event.COMPLETE, function snowloadOver(event:egret.Event) {
            snowsign = true;
        }, this);
        ...
        streetloader.dataFormat = egret.URLLoaderDataFormat.SOUND;
        streetloader.load(new egret.URLRequest("resource/streetdreams.mp3"));
        streetloader.addEventListener(egret.Event.COMPLETE, function streetloadOver(event:egret.Event) {
            streetsign = true;
        }, this);
...
//播放按钮开始
        ...
        function onTouchflowerdance(event:egret.Event){
            ...
            var sound:egret.Sound = flowerloader.data;
            ...
            if(flowersign == true){
                ...
                var flowerplayanime:Function = function () {
        ...
        function onTouchsnowhalation(event:egret.Event){
            ...
            var sound:egret.Sound = snowloader.data;
            ...
            if(snowsign == true){
                ...
                var snowplayanime:Function = function () {
        ...
        function onTouchstreetdreams(event:egret.Event){
            ...
            var sound:egret.Sound = streetloader.data;
            ...
            if(streetsign == true){
                ...
                var streetplayanime:Function = function () {
        ...
        function onTouchtwilight(event:egret.Event){
            ...
            var sound:egret.Sound = twiloader.data;
            ...
            if(twisign == true){
                ...
                var twiplayanime:Function = function () {
...
//第五页开始
        ...
        var sky5:egret.Bitmap = this.createBitmapByName("02_jpg");
        page5.addChild(sky5);
        sky5.width = stageW;
        sky5.height = stageH;
        ...
        var changebrother:Function = function () {
        ...
        var changewealth:Function = function () {
        ...
        var changeuniverse:Function = function () {
        ...
        var brother:egret.Bitmap = this.createBitmapByName("brother_jpg");
        ...
        var wealth:egret.Bitmap = this.createBitmapByName("wealth_jpg");
        ...
        var universe:egret.Bitmap = this.createBitmapByName("universe_jpg");
...
/*
    private picturestartAnimation(picture:any):void {
        var self:any = this;

        var changepicture:Function = function () {

            var picturetw = egret.Tween.get(picture);
            picturetw.to({"alpha": 1}, 200);
            picturetw.wait(2000);
            picturetw.to({"alpha": 0}, 200);
            picturetw.call(changepicture, self);
        };
        changepicture();
    }
*/
